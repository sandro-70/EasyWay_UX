            ...
            <div key={p.id_producto} style={styles.productCard}>
              ...
              p.imagenes[0].url_imagen ? (
                <img
                  ...
                  onError={(e) => {
                    e.target.src =
                      'data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" width="100" height="100" viewBox="0 0 100 100"><rect width="100" height="100" fill="%23f0f0f0"/><text x="50%" y="50%" dominant-baseline="middle" text-anchor="middle" font-family="sans-serif" font-size="12" fill="%23999">Sin imagen</text></svg>';
                  }}
                />
              ) : (
                <div style={styles.productImage}>Sin imagen</div>
              )}
