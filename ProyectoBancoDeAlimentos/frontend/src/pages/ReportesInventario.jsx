          ...
          <table className="table-auto w-full border border-black rounded-lg border-collapse text-center">
            <thead>
              <tr className="border-b border-black">
                <th className="px-4 py-2 bg-[#2B6DAF] text-white text-center border-r border-white rounded-tl-lg">
                  ID de producto
                </th>
                <th className="px-4 py-2 bg-[#2B6DAF] text-white text-center border-r border-white">
                  Producto
                </th>
                <th className="px-4 py-2 bg-[#2B6DAF] text-white text-center border-r border-white">
                  Categoría
                ...
                <th className="px-4 py-2 bg-[#2B6DAF] text-white text-center rounded-tr-lg">
                  Estado
                </th>
              </tr>
            </thead>
